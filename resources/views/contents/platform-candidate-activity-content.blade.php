...
<form  action="javascript:void(0);"   id="platform-form" enctype="multipart/form-data" method="get">
			<input type="hidden" id="prospecting_type_id" name="prospecting_type_id" value=6>
				{{ csrf_field() }}
			...
			<!-- alert/openings search result -->
						 ...
						 >
							...
							<!-- Trigger the modal with a button -->
								...
								<h5 style="margin-left: 1.5%;font-weight: bold;">Candidate Activity <a data-toggle="modal" onclick="$('#btn_candidate_activity_add').show();$('#btn_candidate_activity_save').hide();" data-target="#candidateActivityModal"  class="btn btn-primary">Add Candidate Activity</a></h5>
								<div class="col-md-12"
								>
									<div class="search-table-section">
										<table id="table_candidate_activities_result" class="table">
											<thead>
											  <tr>
												<th>Name</th>											
												<th>Job Type / Location</th>												
...
<!-- Modal -->
<div id="candidateActivityModal" class="modal fade" role="dialog">
	<form id="candidate-activity-form" method="post">
		<input type="hidden" id="candidate_activity_id" name="candidate_activity_id">
			{{ csrf_field() }}
	<div class="modal-dialog">
	  ...
	  <div class="modal-content">
		<div class="modal-header">
		  ...
		  <h4 class="modal-title">Candidate Activity</h4>
		</div>
		<div class="modal-body">
			...
			<div class="form-group">
				<b>First Name</b>
				<input class="form-control" type="text" required id="cda_first_name" name="cda_first_name" value="" placeholder="First Name">
			</div>

			<div class="form-group">
				<b>Last Name</b>
				<input class="form-control" type="text" required id="cda_last_name" name="cda_last_name" value="" placeholder="Last Name">
			</div>

			<div class="form-group">
				<b>Email</b>
				<input class="form-control" type="text" required id="cda_email" name="cda_email" value="" placeholder="email">
			</div>

			<div class="form-group">
				<b>Linkedin Url</b>
				<input class="form-control" type="text" required id="cda_linkedin_url" name="cda_linkedin_url" value="" placeholder="linkedin url">
			</div>
...
<div class="form-group">
<b>Job Type</b>
<select   onchange="loadJobSubTypesCda()" class="form-control" name="cda_job_type_id" id="cda_job_type_id">
...
<div class="form-group">
	<b>Job SubType</b>
	<select class="form-control" style="width:100%"  name="cda_job_subtype_id" id="cda_job_subtype_id">
	...
	<script>
		$("#cda_job_subtype_id").select2();
	</script>


<div class="form-group">
<b>Location</b>
<select class="form-control" name="cda_location_id" id="cd_location_id">
...
<div class="form-group">
	<b>Candidate Activity Type</b>
	<select class="form-control" id="candidate_activity_type_id" name="candidate_activity_type_id">
		<option value="1" selected>Resume Upload </option>
		<option value="3">Expressed Interest </option>
		<option value="6">Left Job </option>
	</select>
...
<div class="form-group">
<button onclick="editCandidateActivity()" class="btn btn-primary" id="btn_candidate_activity_save" type="button">Save</button> <button onclick="addCandidateActivity()" class="btn btn-primary" id="btn_candidate_activity_add" type="button">Add</button>
</div>
...
<!-- candidateActivity Modal -->
		...
		<!-- Edit Ban Modal -->
																	...
																	<form enctype="multipart/form-data"   action="{{ URL::to('add-candidate')}}"    id="candidate-form"  method="post">                        
																		...
																		<div class="modal fade" id="candidateModal" role="dialog">
																			...
																			<div class="modal-content">
																					<div class="modal-header">
																					<button type="button" class="close" data-dismiss="modal">&times;</button>
																					<h4 class="modal-title">Add Candidate Activity</h4>
																					</div>
																					<div class="modal-body">
																						...
																						<div class="form-group">
																							...
																							<div class="form-group">
																								<b>Job SubType</b>
																								<select class="form-control" style="width:100%" multiple="multiple"  name="cda_job_subtype_id" id="cda_job_subtype_id">
																								   @foreach($job_subtypes as $sub_type)	
																									<option value="{{$sub_type->id}}">{{$sub_type->name}}</option>
																									@endforeach
																								</select>
											...
											<div class="form-group">
												<button onclick="editCandidateActivity()" class="btn btn-primary" id="btn_candidate_save" type="button">Save</button> <button onclick="addCandidateActivity()" class="btn btn-primary" id="btn_candidate_activity_add" type="button">Add</button>
											</div>
...
<script src="js/candidate-activity.js"></script>
