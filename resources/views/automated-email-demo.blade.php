...
<div id="banner-section">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<br>
				<h2><b>Powerful Email Automation</b><br>Built for Agency Recruiters</h2>
			</div>
		</div>
	</div>
</div>
			 ...
			 <div class="row">
					...
					<div class="row">
						...
						<div class="whyus-text-mobile visible-xs visible-sm">
								<h3 style="margin-top: 0px;  font-weight: bold;">Step 1: Define Automation Criteria</h3>
<hr style="    /* margin-top: 20px; */
    margin-bottom: 20px;
    border: 0;
    border-top: 4px solid #58759b;">
<p class="explain-font">
Our software is constantly monitoring job boards - when a new role that you care about opens up, we'll send an email on your behalf (from your email address) to the hiring manager.<br><br>Easily define what kind of new openings should prompt an automated email by choosing the locations and job types you cover and set up simple or complex schemes. 
</p>

						<div style="padding:0px" class="col-lg-6">
							<a href="#gif1" class="gif1 "><img style="margin-top: 10px;margin-bottom: 15px;" src="images/step1.gif" width="100%" class="why-gifs"/></a>
						</div>
	

<p class="explain-font">
There is no limit to how many automation schemes you can set up.  Agency recruiter specific customization promotes your brand effectively<br><br>
...
Our software is constantly monitoring job boards - when a new role that you care about opens up, we'll send an email from your email address to the hiring manager.<br><br>Easily define what kind of new openings should prompt an automated email by choosing the locations and job types you cover and set up simple or complex schemes.
						...
						<div class="col-lg-6">
							<a href="#gif1" class="gif1 hidden-xs hidden-sm"><img style="margin-top: 10px;margin-bottom: 10px;" src="images/step1.gif" width="100%" class="why-gifs"/></a>
					...
					<div class="row">
						...
						<div class="whyus-text-mobile visible-xs visible-sm">
								<h3 style="margin-top: 0px;  font-weight: bold;">Step 2: Create Automation Template</h3>
<hr style="    /* margin-top: 20px; */
    margin-bottom: 20px;
    border: 0;
    border-top: 4px solid #58759b;">
...
<p class="explain-font">
After you define your template, Recruiter Intel sends a heavily customized email on your behalf to every hiring manager that opens up a new role in the future, until you shut it off.<br><br>Define your email templates using customization variables that populate depending on the new role that has opened.
</p>

						<div style="padding:0px" class="col-lg-6">
							<a href="#gif2" class="gif2 "><img style="margin-top: 10px;margin-bottom: 15px;" src="images/step2.gif" width="100%" class="why-gifs"/></a>
						</div>
	

<p class="explain-font">
Make a different template for each type of role and location - the more specific, the better!<br><br>
                                                                <a href="#subsform"  class="why-btn inline hidden-sm hidden-xs">Start Trial</a>
</p>
							</div>
...
After you define your template, Recruiter Intel sends a heavily customized email on your behalf to every hiring manager that opens up a new role in the future, until you shut it off.<br><br>Define your email templates using customization variables that populate depending on the new role that has opened.
						...
						<div class="col-lg-6">
							<a href="#gif2" class="gif2 hidden-xs hidden-sm"><img style="margin-top: 10px;margin-bottom: 10px;" src="images/step2.gif" width="100%" class="why-gifs"/></a>
							<a href="#subsform"  class="hidden-xs hidden-sm visible-md why-btn inline">Start Trial</a>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="whyus-text-mobile visible-xs visible-sm">
								<h3 style="margin-top: 0px;  font-weight: bold;">Step 3: Add Follow-Up Steps</h3>
<hr style="    /* margin-top: 20px; */
    margin-bottom: 20px;
    border: 0;
    border-top: 4px solid #58759b;">
<p class="explain-font">
You can stop at just one email, or you can define powerful email automation schemes with an unlimited number of steps.  If the hiring manager doesn't respond in two weeks, you can send another email.  No response after a month? Send just one more.<br><br>Automation stops the moment a hiring manager responds, or the automation scheme has run it's course.
</p>

						<div style="padding:0px" class="col-lg-6">
							<a href="#gif3" class="gif3 "><img style="margin-top: 10px;margin-bottom: 15px;" src="images/step3.gif" width="100%" class="why-gifs"/></a>
						</div>
...
You can stop at just one email, or you can define powerful email automation schemes with an unlimited number of steps.  If the hiring manager doesn't respond in two weeks, you can send another email.  No response after a month? Send just one more.<br><br>Automation stops the moment a hiring manager responds, or the automation scheme has run it's course.
						...
						<div class="col-lg-6">
							<a href="#gif3" class="gif3 hidden-xs hidden-sm"><img style="margin-top: 10px;margin-bottom: 10px;" src="images/step3.gif" width="100%" class="why-gifs"/></a>
							<a href="#subsform"  class="hidden-xs hidden-sm visible-md why-btn inline">Start Trial</a>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="whyus-text-mobile visible-xs visible-sm">
								<h3 style="margin-top: 0px;  font-weight: bold;">Step 4: Respond to Prospecting Alerts</h3>
<hr style="    /* margin-top: 20px; */
    margin-bottom: 20px;
    border: 0;
    border-top: 4px solid #58759b;">
<p class="explain-font">
The moment a hiring manager responds to any of your automated emails, you will receive an alert on the platform (and your email) so you can respond while interest is at it's highest.<br><br>Let the automation do your busy work for you so you can get back to what you do best, placing great talent and great companies.
</p>

						<div style="padding:0px" class="col-lg-6">
							<a href="#gif4" class="gif4 "><img style="margin-top: 10px;margin-bottom: 15px;" src="images/step4.gif" width="100%" class="why-gifs"/></a>
						</div>
...
The moment a hiring manager responds to any of your automated emails, you will receive an alert on the platform (and your email) so you can respond while interest is at it's highest.<br><br>Let the automation do your busy work for you so you can get back to
what you do best, placing great talent and great companies.
</span>
						...
						<div class="col-lg-6">
							<a href="#gif4" class="gif4 hidden-xs hidden-sm"><img style="margin-top: 10px;margin-bottom: 10px;" src="images/step4.gif" width="100%" class="why-gifs"/></a>
							<a href="#subsform"  class="hidden-xs hidden-sm visible-md why-btn inline">Start Trial</a>
						</div>
					</div>
				</div>
				...
				<div style="display: none;">
					<div id="gif1" style="padding: 30px 30px 0;">
						<img src="images/step1.gif" width="100%" style="border-radius: 10px"/>
					</div>
					<div id="gif2" style="padding: 30px 30px 0;">
						<img src="images/step2.gif" width="100%" style="border-radius: 10px"/>
					</div>
					<div id="gif3" style="padding: 30px 30px 0;">
						<img src="images/step3.gif" width="100%" style="border-radius: 10px"/>
					</div>
					<div id="gif4" style="padding: 30px 30px 0;">
						<img src="images/step4.gif" width="100%" style="border-radius: 10px"/>
					</div>
...
<input style="display:none" type="email" style="height:43px" name="user_email" id="user_email" required="" class="form-control" placeholder="Email Address">
...
<img height="1" width="1" style="display:none;" alt="" src="https://dc.ads.linkedin.com/collect/?pid=242484&fmt=gif" />
	...
	<script>
		...
		$(document).ready(function(){
			...
			$(".gif4").colorbox({inline:true, width:"auto", height:"auto"});
		});
